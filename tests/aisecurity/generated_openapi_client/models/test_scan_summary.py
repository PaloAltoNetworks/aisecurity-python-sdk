...
class TestScanSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScanSummary:
        """Test ScanSummary
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScanSummary`
        """
        model = ScanSummary()
        if include_optional:
            return ScanSummary(
